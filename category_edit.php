                ...
                <form method="post">
                    <div class="row gx-3 gy-2">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="title" value="<?php echo $current['title']; ?>">
                        </div>
                        <div class="col">
                            <button class="form-control-sm btn btn-primary" name="updateCat">
                                <i class="feather-edit text-light"></i>
                                Update Category
                            </button>
                        </div>
                    </div>
