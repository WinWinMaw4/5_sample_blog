...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function (d, f, k) {
  d instanceof String && (d = String(d));
  for (var n = d.length, g = 0; g < n; g++) {
    var q = d[g];
    if (f.call(k, q, g, d)) return { i: g, v: q };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
var $jscomp$lookupPolyfilledValue = function (d, f) {
  var k = $jscomp.propertyToPolyfillSymbol[f];
  if (null == k) return d[f];
  k = d[k];
  return void 0 !== k ? k : d[f];
};
$jscomp.polyfill = function (d, f, k, n) {
  f &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(d, f, k, n)
      : $jscomp.polyfillUnisolated(d, f, k, n));
};
$jscomp.polyfillUnisolated = function (d, f, k, n) {
  k = $jscomp.global;
  d = d.split(".");
  ...
  f != n &&
    null != f &&
    $jscomp.defineProperty(k, d, { configurable: !0, writable: !0, value: f });
};
$jscomp.polyfillIsolated = function (d, f, k, n) {
  var g = d.split(".");
  d = 1 === g.length;
  n = g[0];
  n = !d && n in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
  ...
  g = g[g.length - 1];
  k = $jscomp.IS_SYMBOL_NATIVE && "es6" === k ? n[g] : null;
  f = f(k);
  null != f &&
    (d
...
$jscomp.polyfill(
  ...
  function (d) {
    return d
      ? d
      : function (f, k) {
          return $jscomp.findInternal(this, f, k).v;
        };
  },
  "es6",
  "es3"
...
(function (d) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (f, k) {
        f || (f = window);
        return d(k, f, f.document);
      })
    : d(jQuery, window, document);
})(function (d, f, k, n) {
  var g = f.moment ? f.moment : f.dayjs ? f.dayjs : f.luxon ? f.luxon : null,
    q = function (a, b) {
  ...
  d.extend(q.prototype, {
    ...
    val: function (a, b) {
      ...
      if (b || b === n) this.s.d ? this._writeOutput() : this.dom.input.val(a);
    ...
    _constructor: function () {
      ...
      this._optionsTitle();
      d(k).on("i18n.dt", function (e, h) {
        h.oLanguage.datetime &&
          (d.extend(!0, a.c.i18n, h.oLanguage.datetime), this._optionsTitle());
      });
      ...
      this.dom.container
        .on("change", "select", function () {
          ...
          e.hasClass(b + "-month")
            ...
            ? (a.s.d.setUTCMinutes(h), a._setTime(), a._writeOutput(!0), l())
            : e.hasClass(b + "-seconds") &&
              (a.s.d.setSeconds(h), a._setTime(), a._writeOutput(!0), l());
          a.dom.input.focus();
          a._position();
        })
        .on("click", function (e) {
          var h = a.s.d,
            r = e.target.nodeName.toLowerCase(),
            m = "span" === r ? e.target.parentNode : e.target;
          r = m.nodeName.toLowerCase();
          if ("select" !== r)
            if ((e.stopPropagation(), "button" === r))
              if (
                ((m = d(m)),
                (e = m.parent()),
                e.hasClass("disabled") && !e.hasClass("range"))
              )
                m.blur();
                ...
                if (m.parents("." + b + "-time").length) {
                  ...
                  h || (h = a._dateToUtc(new Date())),
                    h.setUTCDate(1),
                    h.setUTCFullYear(m.data("year")),
                    h.setUTCMonth(m.data("month")),
                    h.setUTCDate(m.data("day")),
                    a._writeOutput(!0),
                    a.s.parts.time
                      ? a._setCalander()
                      : setTimeout(function () {
    ...
    _correctMonth: function (a, b) {
      var c = this._daysInMonth(a.getUTCFullYear(), b),
        l = a.getUTCDate() > c;
      a.setUTCMonth(b);
      l && (a.setUTCDate(c), a.setUTCMonth(b));
    },
    ...
    _htmlMonth: function (a, b) {
      ...
      for (var p = 0, t = 0; p < m; p++) {
        var x = new Date(Date.UTC(a, b, 1 + (p - e))),
        ...
        7 === ++t &&
          (this.c.showWeekNumber &&
            r.unshift(this._htmlWeekOfYear(p - e, b, a)),
          h.push("<tr>" + r.join("") + "</tr>"),
          (r = []),
          (t = 0));
      }
      c = this.c.classPrefix;
      l = c + "-table";
      this.c.showWeekNumber && (l += " weekNumber");
      w &&
    ...
    _htmlMonthHead: function () {
      ...
      for (var e = 0; 7 > e; e++) a.push("<th>" + l(e) + "</th>");
      return a.join("");
    },
    ...
    _options: function (a, b, c) {
      ...
      a.empty();
      for (var l = 0, e = b.length; l < e; l++)
        a.append('<option value="' + b[l] + '">' + c[l] + "</option>");
    },
    ...
    _optionsTime: function (a, b, c, l, e) {
      ...
      if (r.length) {
        ...
        if (12 === b) {
          p += "<tr>";
          for (e = 1; 6 >= e; e++) p += x(e, m(e));
          p += x("am", w.amPm[0]);
          p += "</tr><tr>";
          for (e = 7; 12 >= e; e++) p += x(e, m(e));
          p += x("pm", w.amPm[1]);
          p += "</tr>";
          t = 7;
        } else {
          if (24 === b) {
            ...
            for (t = 0; 4 > t; t++) {
              p += "<tr>";
              for (e = 0; 6 > e; e++) (p += x(A, m(A))), A++;
              p += "</tr>";
            }
          } else {
            p += "<tr>";
            for (t = 0; 60 > t; t += 10) p += x(t, m(t), "range");
            e = null !== e ? e : 10 * Math.floor(c / 10);
            p =
              p +
              '</tr></tbody></thead><table class="' +
              (u + " " + u + '-nospace"><tbody><tr>');
            for (t = e + 1; t < e + 10; t++) p += x(t, m(t));
            p += "</tr>";
          }
          t = 6;
        }
    ...
    _position: function () {
      ...
      if (b.hasClass("inline")) b.insertAfter(this.dom.input);
        ...
        var l = b.outerHeight(),
          e = b.outerWidth(),
          h = d(f).scrollTop();
        a.top + c + l - h > d(f).height() &&
          ((c = a.top - l), b.css("top", 0 > c ? 0 : c));
        e + a.left > d(f).width() &&
          ((a = d(f).width() - e),
          "input" === this.c.attachTo &&
    ...
    _setTime: function () {
      ...
      var l = null != c ? c.hour : b ? b.getUTCHours() : 0,
        e = function (h) {
    ...
    _show: function () {
      ...
      d(k).on("keydown." + b, function (l) {
        (9 !== l.keyCode && 27 !== l.keyCode && 13 !== l.keyCode) || a._hide();
      });
      setTimeout(function () {
        d("body").on("click." + b, function (l) {
          d(l.target).parents().filter(a.dom.container).length ||
            l.target === a.dom.input[0] ||
            a._hide();
        });
      }, 10);
    },
      ...
      var b = this.s.d,
        c =
          g && g == f.luxon
            ...
            : g
            ? g.utc(b, n, this.c.locale, this.c.strict).format(this.c.format)
            : b.getUTCFullYear() +
              "-" +
